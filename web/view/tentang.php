...
<body>
  ...
  <section class="page-section about-heading">
    <div class="container">
      <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="assets/gambar/gambar1.jpg"  alt="">
          ...
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              <h2 class="section-heading mb-4">
                ...
                <span class="section-heading-lower">KELOMPOK SCM J</span>
              </h2>
              <ul>
                <li>KIKI RIZKI EMILIA   (152410101039)</li>
                <li>SYAMS RACHMAN W     (152410101054)</li>
                <li>M. FAHMY AMIRUN N.  (152410101082)</li>
                <li>GAVIN LIFFERA K P.  (152410101096)</li>
                <li>M. ZULFARULHAQ A    (152410101129)</li>
              </ul>
            </div>
          </div>
        </div>
